...
def plot_steady_solution():
    ...
    # TODO this isnt the best
    # only show the stuff thats at an index divisible by 0.1
    idx_x = np.where((X/0.1).astype(int)==(X/0.1))
    idx_y = np.where((Y/0.1).astype(int)==(Y/0.1))
